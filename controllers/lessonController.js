  ...
  try {
    ...
    if (!process.env.OPENAI_API_KEY) {
      ...
      const mockExplanation = {
        ...
        pt: "Hoje vamos praticar frases. Eu digo uma frase e você repete.",
      };
      return res.json({
    ...
    const { greeting, explanation } = await getLessonIntro(
      scenario,
      native,
      target,
    );
    ...
    res
      .status(500)
      .json({ error: err.message || "Failed to get lesson intro" });
  }
}
